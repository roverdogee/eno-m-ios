...
https://github.com/Cteros/eno-music

https://github.com/Cteros/eno-m-desktop

感谢原项目大佬的贡献。



这个项目最特别的一点是：整个 App 的代码实现由 Codex 完成。项目所有功能、界面调整、问题排查和工程整理，都是由我提出需求、Codex 直接阅读代码、修改代码、构建验证并持续迭代完成的。我没有写一行代码，只负责描述想要的体验、指出问题、做产品判断和实际测试。

甚至于最终的Github上传与本篇readme的撰写也由CodeX完成。
